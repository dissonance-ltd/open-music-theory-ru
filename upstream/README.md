...
- `en/*.html`: four normalized English chapter bodies: introduction, first two
...
- `assets.json`: 16 locally retained notation figures with source URLs, hashes,
...
source metadata, not substituted for the seven original OMT2 authors. The two
...
Before expanding beyond this pilot, obtain a current official export or an
accessible official source, compare editions, and retain per-chapter revision
