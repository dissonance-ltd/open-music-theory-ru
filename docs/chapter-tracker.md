...
Состояние при введении процесса: 20 сентября 2026 года, после слияния PR #3 (`bde2d57a9a8bf6a0996e1db28f61efb29c573ee4`). Оглавление содержит **136 элементов: 116 ссылок на главы, 6 вводных страниц, 13 разделов и приложение**. В той исходной точке было 7 английских снимков и 6 русских черновиков: введение и главы 1–5. Пилот пакетного процесса добавил главы 6–8. Пакет 04 добавляет главы 9–11: теперь **13 английских снимков и 12 русских черновиков**, 65 локальных иллюстраций. Для глав 9–11 выполнена отдельная сверка ИИ; замечания и проверка исправлений записываются в файлах глав. Человеческая рецензия, полная локализация внешних материалов и просмотр собранных страниц не выполнены. Пакет 05 (главы 12–14) готовится параллельно в отдельной ветке и в эти числа не включён. Остальные тела страниц не оценены; само наличие URL не подтверждает их доступность, объём или полноту медиа.
...
|---|---|---|---|
| Процесс | [Пакетная работа ИИ-агентов](batch-translation.md) | Пилот 6–8 завершён; продолжаются два пакета по три главы с отдельной сверкой | Координатор ИИ / [PR #6](https://github.com/dissonance-ltd/open-music-theory-ru/pull/6) |
...
| Пакет 04: черновики, интеграция | 9–11. Simple Meter; Compound Meter; Other Rhythmic Essentials | Отдельная сверка ИИ выполнена; проверка исправлений и технические результаты — в записях глав/PR | ИИ translate_simple_meter, translate_compound_meter, translate_rhythm_essentials; проверяющие review_meter_a, review_meter_b / `translation/batch-04-meter` |
| Пакет 05 в работе | 12–14. Major Scales; Minor Scales; Diatonic Modes | Параллельный перевод; PR основан на пакете 04 для общей интеграции | ИИ translate_major, translate_minor, translate_modes / `translation/batch-05-scales-modes` |
...
## Пилот интерактивных примеров

[Пилот MuseScore](musescore-embed-pilot.md), 2026-09-23: по одному примеру в главах 6, 10 и 11 встроено через iframe; постоянные ссылки сохранены. Воспроизведение, соответствие партитур и визуальная проверка desktop/mobile не подтверждены. Это изменение представления, не повышение редакционного статуса. Остальные примеры остаются ссылками до проверки пилота.
...
| `toc-chapter-171` | [12. Major Scales, Scale Degrees, and Key Signatures](https://pressbooks.nebraska.edu/openmusictheory/chapter/major-scales/) | Chelsey Hamm and Bryn Hughes | В отдельном пакете 05; в эту ветку не включено | В работе: `translation/batch-05-scales-modes` |
| `toc-chapter-178` | [13. Minor Scales, Scale Degrees, and Key Signatures](https://pressbooks.nebraska.edu/openmusictheory/chapter/minor-scales/) | Chelsey Hamm and Bryn Hughes | В отдельном пакете 05; в эту ветку не включено | В работе: `translation/batch-05-scales-modes` |
| `toc-chapter-184` | [14. Introduction to Diatonic Modes and the Chromatic "Scale"](https://pressbooks.nebraska.edu/openmusictheory/chapter/intro-to-diatonic-modes-and-the-chromatic-scale/) | Chelsey Hamm | В отдельном пакете 05; в эту ветку не включено | В работе: `translation/batch-05-scales-modes` |
