...
**Пример 1. Гармонический и мелодический интервалы.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8418647/s/H5aOaq/embed" title="Пример 1. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8418647/s/H5aOaq">Открыть пример 1 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
...
**Пример 2. Ступеневые величины интервалов.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8418638/s/e4jxEI/embed" title="Пример 2. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8418638/s/e4jxEI">Открыть пример 2 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 3. Знаки альтерации не влияют на ступеневую величину интервала.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8418665/s/n71TMI/embed" title="Пример 3. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8418665/s/n71TMI">Открыть пример 3 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 5. Два интервала.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/6836733/s/wud8Ld/embed" title="Пример 5. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/6836733/s/wud8Ld">Открыть пример 5 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 6. Увеличенные интервалы, полученные (a) повышением верхнего звука и (b) понижением нижнего.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8418677/s/-x_9Yz/embed" title="Пример 6. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8418677/s/-x_9Yz">Открыть пример 6 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 7. Уменьшённые интервалы, полученные (a) понижением верхнего звука и (b) повышением нижнего.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/6836745/embed" title="Пример 7. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/6836745">Открыть пример 7 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 8. Соотношение величин интервалов при изменении (a) верхнего звука и (b) нижнего.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8418728/s/SPtiOU/embed" title="Пример 8. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8418728/s/SPtiOU">Открыть пример 8 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 14. Секунды, терции и кварты между белыми клавишами.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/6836757/embed" title="Пример 14. Интервалы — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/6836757">Открыть пример 14 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
