...
**Пример 12. Четыре ноты в басовом ключе между знаками репризы.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/6275123/embed" title="Пример 12. Другие элементы музыкальной нотации — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/6275123">Открыть пример 12 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
...
Внешний материал не локализован; его содержимое и воспроизведение в этом проходе не проверены. Описание переведено из подписи источника.

<a id="example-13"></a>

**Пример 13. Знак репризы с первой и второй вольтами в скрипичном ключе.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/6275124/embed" title="Пример 13. Другие элементы музыкальной нотации — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/6275124">Открыть пример 13 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
