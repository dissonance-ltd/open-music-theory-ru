...
**Пример 4. Запись примера 2 косыми штрихами и на нотном стане.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8455859/embed" title="Пример 4. Основы пения с листа и музыкального диктанта — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8455859">Открыть пример 4 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
...
> **Примечание переводчиков.** Пять исходных партитур MuseScore встроены в эту главу; под каждым плеером сохранена прямая ссылка. Они не локализованы; их содержимое, доступность и воспроизведение не проверены. Подписи переведены по источнику.
...
**Пример 7. Примеры 5–6 в записи на нотном стане.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8455769/embed" title="Пример 7. Основы пения с листа и музыкального диктанта — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8455769">Открыть пример 7 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 8. Мелодия в протонотации и в записи на нотном стане.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8455748/embed" title="Пример 8. Основы пения с листа и музыкального диктанта — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8455748">Открыть пример 8 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 12. Два варианта нотной записи мелодии из протонотации.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8455691/embed" title="Пример 12. Основы пения с листа и музыкального диктанта — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8455691">Открыть пример 12 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
...
**Пример 13. Три варианта нотной записи мелодии из протонотации.**

<div class="score-embed">
<iframe src="https://musescore.com/user/32728834/scores/8455655/embed" title="Пример 13. Основы пения с листа и музыкального диктанта — MuseScore" width="100%" height="440" loading="lazy" allowfullscreen></iframe>
<p class="score-embed-fallback"><a href="https://musescore.com/user/32728834/scores/8455655">Открыть пример 13 в MuseScore</a> — если плеер не загрузился или нужен полноэкранный просмотр.</p>
<p class="score-embed-note">Плеер загружается с MuseScore и требует подключения к интернету. Нотный пример оставлен на языке оригинала.</p>
</div>
