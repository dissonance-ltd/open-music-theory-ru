...
**Пример 1. Восходящая мажорная гамма.** [Открыть нотный пример в MuseScore](https://musescore.com/user/32728834/scores/6815731/embed).

> **Внешние нотные примеры.** Примеры 1, 2, 3, 5 и 15 сохранены как ссылки на исходные партитуры MuseScore. Их содержимое и воспроизведение не проверены; внутренние надписи не переведены. Русские подписи и описания передают текст главы, а не свидетельствуют о просмотре партитур.
...
**Пример 2. Гамма си-бемоль мажор.** [Открыть нотный пример в MuseScore](https://musescore.com/user/32728834/scores/6823280/embed).
...
**Пример 3. Гамма ре мажор.** [Открыть нотный пример в MuseScore](https://musescore.com/user/32728834/scores/8452298/embed).
...
**Пример 5. Гамма ля-бемоль мажор с названиями ступеней.** [Открыть нотный пример в MuseScore](https://musescore.com/user/32728834/scores/8452340/embed).
...
**Пример 15. Гамма фа-бемоль мажор в скрипичном ключе.** [Открыть нотный пример в MuseScore](https://musescore.com/user/32728834/scores/6817049/embed).
