...
Доступны черновики введения и первых семнадцати глав Fundamentals: введение в западную
...
В книге 18 черновиков и 92 локальные иллюстрации (91 из Nebraska и одна из LibreTexts). Внешние видео, партитуры и рабочие листы пока
...
оглавление Nebraska и 19 английских снимков: восемнадцать переводимых страниц и благодарности.
Пакет 06 добавляет главы 15–17 на основе восстановленного пакета 05.
Сначала объедините [PR #10](https://github.com/dissonance-ltd/open-music-theory-ru/pull/10) в `main`, затем **перенаправьте PR пакета 06 с `translation/restore-batch-05` на `main` до его слияния** и проверьте итоговый diff и CI. Подробности: [upstream/README.md](upstream/README.md).
...
- Сначала объедините [PR #10](https://github.com/dissonance-ltd/open-music-theory-ru/pull/10) в `main`, затем **перенаправьте PR пакета 06 с `translation/restore-batch-05` на `main` до его слияния** и проверьте итоговый diff и CI.
