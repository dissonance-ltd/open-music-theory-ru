...
Доступны черновики введения и первых одиннадцати глав Fundamentals: введение в западную
...
В книге 65 локальных иллюстраций. Внешние видео, партитуры и рабочие листы пока
...
оглавление Nebraska и 13 английских снимков: двенадцать переводимых страниц и благодарности.
Главы 12–14 о гаммах и ладах готовятся параллельно отдельным пакетом;
в эту ветку они ещё не включены. Подробности: [upstream/README.md](upstream/README.md).

Переводы подготовлены с помощью ИИ и требуют независимой терминологической и
содержательной рецензии. В `upstream/translations.json` у всех двенадцати страниц статус
`draft` и нет отметки о рецензенте. Для глав 9–11 выполнена отдельная сверка ИИ;
...
- Провести независимое рецензирование двенадцати черновиков и глоссария.
- Проверить работу внешних упражнений и видео, затем локализовать рабочие листы.
- Завершить параллельный пакет 05: мажорные и минорные гаммы, диатонические лады и хроматическая гамма; состояние — в [трекере](docs/chapter-tracker.md).
